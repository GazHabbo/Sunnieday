            ...
            {
                {
                    ...
                    Customer.statusManager.addStatus("carryd", customerTrigger.serveItem, Config.Statuses_itemCarrying_SipAmount, "drink", Config.Statuses_itemCarrying_SipInterval, Config.Statuses_itemCarrying_SipDuration);
                }
                        ...
                        case 3: // Shout
                            {
                                if (Shouts.Length > 0)
                                {
                                    ...
                                    Room.sendShout(this.roomUID, Shouts[messageID]);
                                }
                                break;
                            }
