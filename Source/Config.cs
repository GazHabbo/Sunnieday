...
namespace Holo
{
    ...
    public static class Config
    {
        ...
        /// </summary>
        internal static byte Items_Stacking_maxHeight;
        /// <summary>
        ...
        public static void Init(bool Update)
        {
            ...
            Rooms_LoadAvertisement_img = "http://www.sunnieday.net/Top_Story/credits_top_story.png";
            if (Rooms_LoadAvertisement_img != "")
            {
                ...
                //if(stringManager.getStringPart(Rooms_LoadAvertisement_uri,0,7) != "http://")
                    Rooms_LoadAvertisement_uri = "http://www.sunnieday.net";
            }
            ...
            Statuses_itemCarrying_SipAmount = (Statuses_itemCarrying_SipDuration + Statuses_itemCarrying_SipInterval) * 7;
            Statuses_Wave_waveDuration = int.Parse(getTableEntry("statuses_wave_duration"));
            Items_Stacking_maxHeight = byte.Parse(getTableEntry("items_stacking_maxstackheight"));
